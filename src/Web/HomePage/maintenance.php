    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            background: linear-gradient(160deg, #f6f4f0 0%, #ede9e2 100%);
            color: #2b2823;
            display: flex;
            align-items: center;
...
<div class="maintenance">
    <div class="maintenance-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="#c44d37" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
